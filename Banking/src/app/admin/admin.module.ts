...
@NgModule({
  ...
  entryComponents: [
    ...
    AddpolicyComponent,PolicyComponent,ViewpolicyComponent,AddaccountComponent,AccountComponent,ViewaccountComponent,
  ],
  declarations: [
    ...
    PolicyComponent,AddpolicyComponent,ViewpolicyComponent ,AccountComponent,AddaccountComponent,ViewaccountComponent ]
})
